...
are still correct when you read this and are only guaranteed to be updated at a course event.
...
-   [Slurm version 23.02.7, on the system after the August-September 2024 update](https://slurm.schedmd.com/archive/slurm-23.02.7/)
