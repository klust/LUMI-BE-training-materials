...
in `/scratch/project_46YXXXXXX/$USER/eb-course` (in your own scratch directory).
...
-   Set `EBU_USER_PREFIX`: 
    ...
    ```
    export EBU_USER_PREFIX=/scratch/project_46YXXXXXX/$USER/eb-course
    ```
...
-   At the end, when you don't need the software installation anymore, you can simply remove the directory
    ...
    ```
    rm -rf /scratch/project_46YXXXXXX/$USER/eb-course
    ```
