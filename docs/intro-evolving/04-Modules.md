...
<figure markdown style="border: 1px solid #000">
  ![Environment modules implementations](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/EnvironmentModulesImplementations.png)
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![module spider cray-fftw/3.3.10.11](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleSpiderFFTWVersion_1.png)
</figure>

<figure markdown style="border: 1px solid #000">
  ![module spider cray-fftw/3.3.10.11](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleSpiderFFTWVersion_2.png)
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![module spider gnuplot/6.0.3-cpeGNU-25.09 screen 1](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleSpiderGnuplotVersion_1.png)
</figure>

<figure markdown style="border: 1px solid #000">
  ![module spider gnuplot/6.0.3-cpeGNU-25.09 screen 2](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleSpiderGnuplotVersion_2.png)
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![module spider cmake with Spack](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleSpiderCMake5.png)
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![module spider CMake/4.2.3](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleSpiderCMakeVersion_1.png)
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![module keyword https editor 1](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleKeywordEditor_1.png)
</figure>

<figure markdown style="border: 1px solid #000">
  ![module keyword https editor 2](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-04-Modules/ModuleKeywordEditor_2.png)
</figure>
...
-   VSC
    ...
    -   VSC@UGent: Modules are briefly coverd in the "Introduction to HPC-UGent" course. The Lmod setup on the
        ...
        -   [Slides](https://www.ugent.be/hpc/en/training/2025/hpcugent-intro-2025-09-17/@@download/file/Introduction-to-HPC-UGent-2025-09-17.pdf) and [YouTube recording](https://www.ugent.be/hpc/en/training/introhpcugent-recording)
            of the September 17, 2025 session.
...
-   CÉCI: 
    ...
    -   [YouTube video: Choosing and activating software with system modules on CÉCI clusters](https://www.youtube.com/watch?v=d2wCgZkI4oM)
        from the fall 2024 introductory courses.
