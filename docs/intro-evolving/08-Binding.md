...
<figure markdown style="border: 1px solid #000">
  ![Slide checking bindings](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/CheckBindings.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task distribution with Slurm (3)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/SlurmTaskDistribution_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-CPU binding with Slurm: Why?](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/SlurmTaskCPUWhy.png){ loading=lazy }
</figure>

In the [chapter on the LUMI architecture](01-Architecture.md),
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-CPU binding with Slurm: How?](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/SlurmTaskCPUHow.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-GPU binding with Slurm (1)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/SlurmTaskGPU_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-GPU binding with Slurm (2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/SlurmTaskGPU_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide MPI rank redistribution with Cray MPICH (1)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/MPICHRankRedistribution1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide MPI rank redistribution with Cray MPICH (2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/MPICHRankRedistribution2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear GCD, match CPU, OpenMP](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismLinearGCD3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear GCD, match CPU, OpenMP](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismLinearGCD4.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear CCD, match GCD, with cpus-per-task](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismLinearCCD4.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear CCD, match GCD, with cpus-per-task](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismLinearCCD5.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear CCD, match GCD, with cpus-per-task](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismLinearCCD6.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 1](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismGreenRing1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 2](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismGreenRing2.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 3](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismGreenRing3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 4](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismGreenRing4.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 5](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-08-Binding/ROCRMechanismGreenRing5.png){ loading=lazy }
</figure>
...
-   Another presentation on distribution and binding can be found in the pre-2025
    ...
    ["Advanced Placement" talk in the course in Amsterdam in October 2024](https://lumi-supercomputer.github.io/LUMI-training-materials/4day-20241028/extra_2_01_Advanced_Application_Placement/)
