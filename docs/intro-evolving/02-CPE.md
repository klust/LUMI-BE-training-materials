...
Cray Debugging Support Tools that will not be discussed in this introductory course, and
...
to the advanced trainings that the LUMI User Support Team organises several times a year with HPE for more material.
...
!!! Note "Currently missing in the system `rocm/6.3.4` module."
    ...
    discuss the software stacks](05-SoftwareStacks.md).
