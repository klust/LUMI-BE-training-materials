...
`46YXXXXXX`, replace with the number of your project (likely a number
starting with 465 for a project obtained via LUMI-BE).

1.  This exercise is the first step in preparing the environment needed for exercise 3
    and later.
...
13. Should you want to clean up your space on LUMI-O and remove the buckets used in the 
