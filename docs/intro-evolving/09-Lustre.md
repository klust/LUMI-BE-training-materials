...
<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing a file](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreFileAccess.png){ loading=lazy }
</figure>
