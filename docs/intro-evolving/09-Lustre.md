...
<figure markdown style="border: 1px solid #000">
  ![File systems on LUMI](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/FileSystemLumi.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks1_1_separation.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks (2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks2.png){ loading=lazy }
</figure>
...
1.  **Metadata servers (MDSes)**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks1_2_MDS.png){ loading=lazy }
    </figure>
...
2.  **Object storage servers (OSSes)**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks1_3_OSS.png){ loading=lazy }
    </figure>
...
3.  **Lustre clients**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks1_4_client.png){ loading=lazy }
    </figure>
...
4.  **High-performance interconnect**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreBuildingBlocks1_5_network.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Large files are spread across OSTs](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreFileStriping.png){ loading=lazy }
</figure>
...
1.  The first step is opening the file. 
    ...
    <figure markdown style="border: 1px solid #000">
      ![Accessing querymds](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreFileAccess_1_queryMDS.png){ loading=lazy }
    </figure>
...
2.  MDS answers:
    ...
    <figure markdown style="border: 1px solid #000">
      ![Accessing returnmds](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreFileAccess_2_returnMDS.png){ loading=lazy }
    </figure>
...
3.  Data access:
    ...
    <figure markdown style="border: 1px solid #000">
      ![Accessing-writeoss](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreFileAccess_3_writeOSS.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 1)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreParallelismKey_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreParallelismKey_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![How to determine the striping values?](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreDetermineParameters.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (1)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreManageStriping1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreManageStriping2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (3)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreManageStriping3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (4)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreManageStriping4.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The metadata servers (2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreMDS_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![The metadata servers (1)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LustreMDS_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre on LUMI](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-09-Lustre/LumiLustreOnLumi.png){ loading=lazy }
</figure>
...
-   Within the VSC, several of the Python trainings already pay attention to working efficiently with
    datasets in Python.
