...
<!--
<figure markdown style="border: 1px solid #000">
  ![Slide Partitions allocatable per node](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/PartitionsPerNode.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Partitions allocatable by resources](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/PartitionsByResources.png){ loading=lazy }
</figure>
-->
...
1.  **"Per-node allocations":** Request suitable nodes (number of nodes and partition) with `sbatch` or `salloc`
    ...
    MPI ranks. This will be the topic of the [next chapter of the course](08-Binding.md) and is for some applications very important
...
[chapter "Process and thread distribution and binding"](08-Binding.md) for a more elaborate
...
with the latter the default on LUMI. 
The hint should be given as an option to
`sbatch`(e.g., as a line `#SBATCH --hint=multithread`) and not as an option of
`srun` as unexpected behaviour does sometimes occur when `--hint=nomultithread`
which is implicitly defined by the default options for Slurm on LUMI is overwritten
at the `srun` level with `--hint=multithread`.
...
??? example "Use of `--hint=(no)multithread` (click to expand)"
    ...
    sleep 5 # To give Slurm the time to update its databases after a job step
    echo -e "\nsacct for the job:\n$(sacct -j $SLURM_JOB_ID)\n"
    ```
    ...
    1.  Without the `#SBATCH --hint=multithread` line to see the default behaviour of Slurm on LUMI.
        ...
        4238727.0     omp_check            project_4+          8  COMPLETED      0:0 
        ```
    ...
    2.  Now replace the `#SBATCH --hint=multithread`  with `#SBATCH --hint=nomultithread`.
        ...
        4238730.0     omp_check            project_4+          8  COMPLETED      0:0 
        ```
...
!!! bug "`--ntasks-per-gpu=<number>` does not always work as expected"
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job environment](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/JobEnvironment.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Automatic requeueing](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/AutomaticRequeueing.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job dependencies](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/JobDependencies.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Interactive jobs with srun](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/JobInteractiveSrun.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Inpecting a running job](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/JobInteractiveAttach.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job arrays](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/JobArrays.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/HeterogeneousJobs.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs: Example with #SBATCH](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/HeterogeneousJobsExampleSBATCH.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs: Example with srun](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/HeterogeneousJobsExampleSrun.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Slurm multi-prog](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/Multiprog.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Simultaneous job steps](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/SimultaneousJobSteps.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job monitoring with sstat 1](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/MonitoringSstat_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Job monitoring with sstat 2](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/MonitoringSstat_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 1](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/MonitoringSacct_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 2](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/MonitoringSacct_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 3](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/MonitoringSacct_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information from sreport](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-07-Slurm/MonitoringSreport.png){ loading=lazy }
</figure>
