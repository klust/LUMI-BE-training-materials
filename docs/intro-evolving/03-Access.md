...
<figure markdown style="border: 1px solid #000">
  ![Slide File Spaces Project (1)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-03-Access/FileSpacesProject1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide File Spaces Project (2)](https://465000095.lumidata.eu/training-materials-web/intro-evolving/img/LUMI-BE-Intro-evolving-03-Access/FileSpacesProject2.png){ loading=lazy }
</figure>
...
!!! Demo "A walk through the Open OnDemand interface"
    ...
    Belgian users typically need the "Puhuri" option, but users who came in via the myCSC
    platform need to use "Haka" or "CSC" depending on how they enter the myCSC platform.
